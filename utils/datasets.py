...
class pop_HiC_Dataset(InMemoryDataset):
    ...
    def process(self): 
        ...
        self.shape, self.binSize, self.chrlims, edge_index, edge_attr = p.make_ptg_pophic_edge_index(osp.join(self.raw_dir, '{}_{}kb.npz'.format(self.condition, self.binSize)))
